...
const contractABI = require("../artifacts/contracts/Openaiembeddings.sol/Openaiembeddings.json").abi;

program
    .name("openaiembeddings-cli")
    .description("CLI tool for Openaiembeddings smart contract")
    .version("1.0.0");
